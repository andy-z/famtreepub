...
class OdtWriter(object):
    ...
    def write(self, model):
        ...
        plProp = style.PageLayoutProperties(pageheight=str(self.page_height),
                                            pagewidth=str(self.page_width),
                                            marginleft=str(self.margins[MARGIN_LEFT]),
                                            marginright=str(self.margins[MARGIN_RIGHT]),
                                            margintop=str(self.margins[MARGIN_TOP]),
                                            marginbottom=str(self.margins[MARGIN_BOTTOM]))
