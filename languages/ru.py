...
OpenOffice для отображения всех глав и номеров страниц. Когда Вы откроете файл в, например, LibreOffice, найдите в меню и
запустите команду "Обновление оглавления и индексов", которая должна обновить Таблицу Оглавления (находится в конце файла).
